...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L0] = LAYOUT_ergodox(
    ...
    XXXXXXX, XXXXXXX, KC_APP, KC_LGUI,  LT(L1, JP_MEISU),
    XXXXXXX, XXXXXXX,
    XXXXXXX,
    KC_SPC,  LT(L2,JP_MEISU), XXXXXXX,
    ...
    XXXXXXX, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSHIFT,
             LT(L2, JP_MKANA), KC_RALT, KC_RGUI, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX,
    XXXXXXX,
    XXXXXXX, JP_MKANA, KC_ENT
  ),
  [L1] = LAYOUT_ergodox(
    _______, JP_EXLM, JP_DQT,  JP_HASH, JP_DLR,  JP_PERC, _______,
    _______, _______, _______, _______, _______, _______, _______,
    _______, JP_DOT,  JP_SLSH, JP_ASTR, JP_MINS, JP_PLUS,
    _______, _______, JP_CIRC, JP_AT,   JP_MINS, JP_YEN, _______,
    _______, _______, _______, _______, _______,
    _______, RESET,
    _______,
    _______, _______, _______,

    _______, JP_AMPR, JP_QUOT, JP_LPRN, JP_RPRN, _______, _______,
